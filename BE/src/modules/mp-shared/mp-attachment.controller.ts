// VoltHub — Attachment controller GENERIK (Inspeksi MP & HAR MP). Mirror
// gh-shared/gh-attachment.controller; parameterized oleh service instance per modul.
...
import type { createMpAttachmentService } from './mp-attachment.service';

type MpAttachmentService = ReturnType<typeof createMpAttachmentService>;

export function createMpAttachmentController(service: MpAttachmentService) {
  return {
