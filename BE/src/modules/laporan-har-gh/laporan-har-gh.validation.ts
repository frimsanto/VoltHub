...
import {
  ...
  looseSection,
  kubikelArraySchema,
} from '../laporan-inspeksi-gh/laporan-inspeksi-gh.validation';
...
const sectionFields = {
  ...
  media1: looseSection,
  media2: looseSection,
  kubikel: kubikelArraySchema, // sama seperti Inspeksi GH (array dinamis per penyulang)
...
export const createLaporanHarGhSchema = z.object({
  workOrderId: z.string().min(1, 'workOrderId wajib').max(36),
  reportDate: reportDateSchema,
  ...sectionFields,
});

export const updateLaporanHarGhSchema = z.object({
  reportDate: reportDateSchema.optional(),
  ...sectionFields,
});

export const decideLaporanHarGhSchema = z.object({
...
export const listLaporanHarGhQuerySchema = z.object({
...
export type CreateLaporanHarGhInput = z.infer<typeof createLaporanHarGhSchema>;
export type UpdateLaporanHarGhInput = z.infer<typeof updateLaporanHarGhSchema>;
export type DecideLaporanHarGhInput = z.infer<typeof decideLaporanHarGhSchema>;
export type ListLaporanHarGhQuery = z.infer<typeof listLaporanHarGhQuerySchema>;
